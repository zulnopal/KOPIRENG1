	...
	if (isset($_POST['update'])) {
		...
		if (!empty($lokasifoto)) {
			...
			$koneksi->query("UPDATE tb_produk SET nama_produk='$_POST[nama_produk]',
							 harga_produk='$_POST[harga_produk]', kategori='$_POST[kategori]',
		...
		<div class="card-body card-block">
			<form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">  
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="kategori" placeholder="Kategori" class="form-control" value="<?php echo $pecah['berat_produk']; ?>">
